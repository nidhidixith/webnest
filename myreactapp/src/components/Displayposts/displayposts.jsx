...
import { handlePostLikes, handlePostUnLikes, handleGetLikes } from '../DisplayPosts/Likes/likescomponent.jsx';
import { handleCommentButtonClick, handleGetComments } from '../DisplayPosts/Comments/CommentsComponent.jsx';
        ...
        {userData.map((post) => (
            ...
            <>
                ...
                <div className="like-comments-display">
                    {post.likeCount  && (
                    <button className="like-count-button" onClick={() => handleGetLikes(post.id,setShowLikesModal, setLikes)}>
                        <p className="like-count">{post.likeCount} likes</p>
                    </button>
                    )}
                    {post.commentsCount !== 0 && (
                    <button className="comment-count-button" onClick={() => handleGetComments(post.id,setShowCommentModal,setComments)}>
                ...
                <div className="user-post-button-container">
                    {!post.liked ? (
                        <button className="like-button-default" onClick={() => handlePostLikes(post.id,fetchUserData, setUserData)}>Like</button>
                    ) : (
                        <button className="like-button-liked" onClick={() => handlePostUnLikes(post.id,fetchUserData,setUserData)}>Like</button>
                    )}
                    <button onClick={() => handleCommentButtonClick(post.id,setShowCommentBox)}>Comment</button>
                    <button>Share</button>
